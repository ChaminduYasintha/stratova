...
export const WhyChooseUs = () => {
  return (
    <section id="why-choose-us" className="w-full flex flex-col relative overflow-hidden bg-white">
      ...
      {/* Top White Section */}
      <div className="w-full bg-white pt-20 md:pt-32 pb-12 px-12 md:px-24 relative">
      ...
      <div className="w-full bg-stratova-dark pt-16 pb-24 px-12 md:px-24 flex-grow flex flex-col items-center">
        
        <div className="flex flex-col gap-10 md:gap-14 w-fit max-w-4xl mx-auto">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="text-xl md:text-3xl font-medium text-white leading-snug whitespace-pre-line">
                  {reason.title}
                </h3>
              </div>
            </motion.div>
      ...
      <div className="w-full bg-stratova-dark pb-12 px-12 md:px-24 flex justify-between items-center relative">
        <div className="flex-1 flex justify-center gap-6">
          {[...Array(5)].map((_, i) => (
            <div key={i} className={`w-3 h-3 ${i === 0 ? 'bg-stratova-green' : 'bg-stratova-green/30'}`}></div>
          ))}
        </div>
