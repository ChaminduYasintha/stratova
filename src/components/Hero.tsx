  ...
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col bg-white">
      ...
      <div className="relative w-full flex-none h-[40vh] bg-white">
        ...
        <div className="absolute bottom-8 left-12 md:left-24 flex gap-8 md:gap-12">
          {[1, 2, 3, 4, 5].map((item) => (
        ...
        {/* Right - Logo */}
        <div className="absolute bottom-4 right-12 md:right-24 w-40 md:w-64">
          <Logo className="w-full h-auto object-contain object-bottom" />
        </div>
      </div>

      {/* Bottom Half - Dark Blue */}
      <div className="relative w-full flex-1 bg-stratova-dark flex flex-col justify-center px-12 md:px-24 py-12">
